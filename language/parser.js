...
function parseOperationDefinition(lexer) {
  ...
  var name = peek(lexer, _lexer.TokenKind.NAME) ? parseName(lexer) : null;
  return {
    kind: _kinds.OPERATION_DEFINITION,
    operation: operation,
    name: name,
...
function parseObjectTypeDefinition(lexer) {
  ...
  var directives = parseDirectives(lexer, true);
  var fields = parseFieldDefinitions(lexer);
  return {
 ...
 */
function parseFieldDefinitions(lexer) {
  return many(lexer, _lexer.TokenKind.BRACE_L, parseFieldDefinition, _lexer.TokenKind.BRACE_R);
}
...
function parseInputObjectTypeDefinition(lexer) {
  ...
  var name = parseName(lexer);
  var directives = parseDirectives(lexer, true);
  var fields = many(lexer, _lexer.TokenKind.BRACE_L, parseInputValueDef, _lexer.TokenKind.BRACE_R);
  return {
...
function parseObjectTypeExtension(lexer) {
  ...
  var interfaces = parseImplementsInterfaces(lexer);
  var directives = parseDirectives(lexer, true);
  var fields = peek(lexer, _lexer.TokenKind.BRACE_L) ? parseFieldDefinitions(lexer) : [];
